// Script to update the blog post with proper blog format
const fs = require('fs');

const blogContent = `# AIが変えた我が家の休日〜40代パパが見つけた新しい時間の楽しみ方〜
...
const updateData = {
  id: "sOY5WwoEBY24iuIm0D221W",
  title: "AIが変えた我が家の休日〜40代パパが見つけた新しい時間の楽しみ方〜",
  content: blogContent,
  excerpt: "AIを使い始めてから変わった我が家の休日の過ごし方について、40代3児の父親が実体験をもとに書きます。料理、子どもの宿題サポート、趣味の時間など、AIが効率化だけでなく質の向上をもたらした具体例と、注意すべきポイントもご紹介します。",
  category: "テクノロジー・AI"
};
