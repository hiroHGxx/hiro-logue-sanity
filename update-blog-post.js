// Script to update the blog post with new content
const fs = require('fs');

const newBlogContent = `# AIが変えた我が家の休日〜40代パパが見つけた新しい時間の楽しみ方〜
...
const updateData = {
  ...
  excerpt: "AIを使い始めてから変わった我が家の休日の過ごし方について、40代3児の父親が実体験をもとにお話しします。料理、子どもの宿題サポート、趣味の時間など、AIが効率化だけでなく質の向上をもたらした具体例と、注意すべきポイントもご紹介します。",
  category: "テクノロジー・AI"
};
